...
{
    /// <inheritdoc />
    public partial class SeedingDifficultiesandRegionsdata : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("16cc6452-220d-4063-b8eb-8b1c8d4bc7d6"), "Easy" },
                    { new Guid("26d4ea37-3f2b-4a9a-b802-85e3482b4f74"), "Hard" },
                    { new Guid("fda0488d-0150-474d-acdd-5674817d771a"), "Medium" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("16cc6452-220d-4063-b8eb-8b1c8d4bc7d6"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("26d4ea37-3f2b-4a9a-b802-85e3482b4f74"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("fda0488d-0150-474d-acdd-5674817d771a"));
